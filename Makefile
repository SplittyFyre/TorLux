...
obj/Socks.o: src/network/Socks.cpp include/Socks.h include/TorLux.h \
  include/util.h
...
bin/torlux: obj/main.o obj/UI.o obj/TorLux.o obj/util.o obj/Generate.o obj/Sender.o obj/Socks.o obj/Server.o
	g++ -std=c++17 -O0 -pthread -MMD -Wall -L"lib" obj/main.o obj/UI.o obj/TorLux.o obj/util.o obj/Generate.o obj/Sender.o obj/Socks.o obj/Server.o -o bin/torlux -lncurses
