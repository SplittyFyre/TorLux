all: bin/torlux
obj/main.o: src/main.cpp include/Socks.h include/TorLux.h \
 include/Generate.h include/Context.h include/UI.h
...
obj/TorLux.o: src/chat/TorLux.cpp include/TorLux.h include/Socks.h \
 include/UI.h include/Server.h include/Context.h
...
bin/torlux: obj/main.o obj/blunder.o obj/Generate.o obj/TorLux.o obj/Context.o obj/Socks.o obj/Server.o obj/UI.o
	g++ -std=c++17 -O0 -pthread -MMD -Wall -L"lib" -lncurses obj/main.o obj/blunder.o obj/Generate.o obj/TorLux.o obj/Context.o obj/Socks.o obj/Server.o obj/UI.o -o bin/torlux
