...
bin/torlux: obj/main.o obj/util.o obj/Generate.o obj/TorLux.o obj/Sender.o obj/Socks.o obj/Server.o obj/UI.o
	g++ -std=c++17 -O0 -pthread -MMD -Wall -L"lib" obj/main.o obj/util.o obj/Generate.o obj/TorLux.o obj/Sender.o obj/Socks.o obj/Server.o obj/UI.o -o bin/torlux -lncurses
